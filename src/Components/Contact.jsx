...
export default function Contact() {
  ...
  return (
    <div id='contact' className="min-h-screen bg-black flex items-center justify-center -mt-64 md:mt-30 p-4 relative overflow-hidden">
      ...
      <div className="w-full max-w-md relative z-10">
        ...
        <div className="text-center mt-6">
          <p className="text-gray-400 text-xs">
            Join our community of professionals and grow your network
          </p>
        </div>
      </div>
    </div>
